...
import cache.Cache;
import controller.Controller_Person_Employee;
 ...
 * @author gruber
 */
public class Container_Person_Employee {
    ...
    public Parent getComponent() {
        ...
        tableColumn = new TableColumn("Cargo");
        tableColumn.setMinWidth(Cache.width * 0.127);
        tableColumn.setCellValueFactory(
        ...
        tableColumn = new TableColumn("Salário");
        tableColumn.setMinWidth(Cache.width * 0.127);
        tableColumn.setCellValueFactory(
        ...
        Thread thread = new Thread(() -> {
            new Controller_Person_Employee().control(this);
        });
        thread.start();
    ...
    public void updateTable() {
        ...
        tableView.setItems(list_employees);
    }
    ...
    public Label getLabel_function() {
        return label_function;
    }

    public void setLabel_function(Label label_function) {
        this.label_function = label_function;
    }
    ...
    public TextField getField_function() {
        return field_function;
    }

    public void setField_function(TextField field_function) {
    ...
    public TableView<Person_Employee> getTableView() {
        return tableView;
    }

    public void setTableView(TableView<Person_Employee> tableView) {
    ...
    public ArrayList<TableColumn<Person_Employee, String>> getColumns() {
        return columns;
    }
