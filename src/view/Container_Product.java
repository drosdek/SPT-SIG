...
public class Container_Product {
    ...
    private TextField field_name, field_description, field_image, field_model,
    ...
    private final List<Product_Stock> stocks = new ArrayList();
    private final List<Product_Price> prices = new ArrayList();
    ...
    public Parent getComponent() {
        ...
        gridPane_register.add(field_model, 5, 5);
    ...
    public TextField getField_model() {
        return field_model;
    }

    public void setField_model(TextField field_model) {
