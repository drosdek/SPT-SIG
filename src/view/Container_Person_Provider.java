...
import cache.Cache;
import controller.Controller_Person_Provider;
 ...
 * @author gruber
 */
public class Container_Person_Provider {
    ...
    public Parent getComponent() {
        ...
        label_company = new Label("Companhia");
        ...
        gridPane_register.add(label_company, 4, 7);
        gridPane_register.add(field_company, 5, 7);
        ...
        tableColumn.setMinWidth(Cache.width * 0.0635);
        tableColumn.setCellValueFactory(
        ...
        tableColumn = new TableColumn("Companhia");
        tableColumn.setMinWidth(Cache.width * 0.127);
        tableColumn.setCellValueFactory(
        ...
        Thread thread = new Thread(() -> {
            new Controller_Person_Provider().control(this);
        });
        thread.start();
    ...
    public Label getLabel_company() {
        return label_company;
    }

    public void setLabel_company(Label label_company) {
    ...
    public TextField getField_company() {
        return field_company;
    }

    public void setField_company(TextField field_company) {
    ...
    public TableView<Person_Provider> getTableView() {
        return tableView;
    }

    public void setTableView(TableView<Person_Provider> tableView) {
    ...
    public ArrayList<TableColumn<Person_Provider, String>> getColumns() {
        return columns;
    }
